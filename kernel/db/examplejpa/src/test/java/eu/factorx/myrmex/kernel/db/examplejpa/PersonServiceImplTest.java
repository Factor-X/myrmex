...
import eu.factorx.myrmex.kernel.db.examplejpa.impl.PersonServiceImpl;
...
public class PersonServiceImplTest {
    ...
    public void testWriteRead() throws Exception {
        ...
        ic.bind("osgi:service/javax.sql.DataSource/(osgi.jndi.service.name=jdbc/postgresds)", ds);
